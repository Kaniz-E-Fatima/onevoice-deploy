        ...
        <div className="chat-window">
          <div className="chat-header">
            ...
            <div className="lang-selector">
              ...
              <div className="lang-row lang-row-mixed">
                <span className="lang-mix-label">Mix:</span>
                {LANGUAGES_MIXED.map(lang => (
                  <button
                    key={lang.code}
                    className={`lang-btn lang-btn-mixed ${language === lang.code ? 'active' : ''}`}
                    onClick={() => handleLanguageChange(lang.code)}
                  >{lang.label}</button>
                ))}
              </div>
